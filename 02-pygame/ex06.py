...
# 이미지 로드
player = pygame.image.load("./02-pygame/character.png")
enemy = pygame.image.load("./02-pygame/enemy.png")
...
# 음악 및 효과음 로드
pygame.mixer.music.load("./02-pygame/bgm.mp3")
pygame.mixer.music.play(-1)  # 무한 반복

sound = pygame.mixer.Sound("./02-pygame/effect.wav")
