...
class Game:
    ...
    def draw(self):
        ...
        # 조작법 안내
        help_text = pygame.font.Font(None, 24).render("WASD/방향키: 이동, 마우스 클릭: 공격", True, GRAY)
    ...
    def game_over_screen(self):
        ...
        game_over_text = pygame.font.Font(None, 72).render("게임 오버!", True, RED)
        score_text = pygame.font.Font(None, 48).render(f"최종 점수: {self.score}", True, WHITE)
        wave_text = pygame.font.Font(None, 48).render(f"도달한 웨이브: {self.wave}", True, WHITE)
        restart_text = pygame.font.Font(None, 36).render("R키를 눌러 재시작, Q키를 눌러 종료", True, WHITE)
